...
<section id="MeetTheTeam">
    ...
    5-5-5 pictures 
    Layout change: 
    @tablet: 2-2 pictures in a row. display Brigi, Claire, Hari and Roman only. 
    @mobile: 1-in-a-row. display Brigi, Claire, Hari, Roman and Judit Szender only.
...
<section id="Careers">
	<!-- 
    h2, paragraph.
    Each job opportunity has a specific fixed height. Inline-blocks.
    Hover on the preview text paints the name and place of the job opportunity blue.
    Clicking on a job opportunity shows the details in an overlay sliding from the right.
    -->
</section>
<!-- END Careers -->
...
<div class="JobOpportunityModal" id="TheIDofTheJobOpportunity">
	<!-- jobtitle: h2,
    	intro paragraph: p,
        Required, Preferred lists: ul
        compensations: p,
        Are you up for the pos: p
        1xBlackButton, 1xBlueButton
        A big closing X top-right 
        SHARE button hover: slides the social share icons from behind the button
        -->
</div>
